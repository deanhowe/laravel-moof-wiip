...
final class MoofImageProcessCommand extends Command implements PromptsForMissingInput
{
    ...
    protected $description = 'Generate the images, yep all of them!';

    private function exactRawDomainAssetsPath()
    {
        return app_path();
    }
    private function exactPublishedDomainAssetsPath()
    {
        return public_path();
    }
    /**
...
//        $rawAssets = (new Filesystem)->allFiles($this->exactRawDomainAssetsPath());
//        $publishedAssets = (new Filesystem)->allFiles($this->exactPublishedDomainAssetsPath());
        $rawAssets = $this->exactRawDomainAssetsPath();
        $publishedAssets = $this->exactPublishedDomainAssetsPath();
